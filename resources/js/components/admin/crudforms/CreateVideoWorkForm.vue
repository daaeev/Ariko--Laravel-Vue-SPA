<template>
    <form @submit.prevent="submitForm" id="create-video-work-form" enctype="multipart/form-data">
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            const result = new FormData(document.querySelector('#create-video-work-form'));
